...
function setup() {
  ...
  monCercle = new Circle(width / 2, height / 2, 90, context);
...
function mouseMoved(e) {
  ...
  if (monCercle.isInMe(e.clientX, e.clientY)) {
    // on change la couleur du cercle
    console.log("isInMe", e.clientX, e.clientY);
    // circle.rotate();
    monCercle.isOver = true;
  } else {
    monCercle.isOver = false;
  }
}
